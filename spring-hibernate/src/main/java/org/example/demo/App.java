...
public class App {
	public static void main(String[] args) {
		try {
			...
			// System.out.println(employeeService.findEmployeeById(100));
			System.out.println(employeeService.updateEmployee(100, new Employee("Marry", 45000)));
			employeeService.deleteEmployee(9330);
		} catch (Exception e) {
